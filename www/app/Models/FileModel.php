...
class FileModel extends Model
{
    ...
    //         ])
    //         ->groupBy('iv_file.idx')
    //         ->orderBy('iv_applier.idx','desc');

    //     return $aAllprofile;
    // }

    public function getComImg($comImgIdx)
    {
        $aRow = $this
            ->select('file_save_name')
            ->where([
    ...
    // public function getMypageProfile(int $memIdx){
    //     if (!$memIdx) {
    //         $aMypageProfile = "";
    //         return $aMypageProfile;
    //     }
    ...
    public function getChumbuFileInfo(int $fileIdx): array
    {
        if (!$fileIdx) {
            $aProfile = "";
            return $aProfile;
