...
if (!function_exists('alert_back_reload')) {
    // alert 띄우고 뒤로 이동후 새로고침
    function alert_back_reload($msg, $exit = true)
    {
        echo "<meta http-equiv=\"content-type\" content=\"text/html; charset=\"utf-8\">";
        echo "<script type='text/javascript' charset='utf-8'> alert( decodeURI('" . $msg . "'));window.location=document.referrer;</script>";
        if ($exit) exit;
    }
}
