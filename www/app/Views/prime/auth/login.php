...
<head>
    ...
    <title>highbuff admin | Log in</title>

    <!-- Google Font: Source Sans Pro -->
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700&display=fallback">
    <!-- Font Awesome -->
    <link rel="stylesheet" href="<?=$data['url']['menu']?>/plugins/fontawesome-free/css/all.min.css">
    <!-- icheck bootstrap -->
...
<body class="hold-transition login-page">
    ...
    <div class="login-box">
        <div class="login-logo">
            <a href="../../index2.html"><b>highbuff admin</b></a>
        </div>
        <!-- /.login-logo -->
        <div class="card">
            <div class="card-body login-card-body">
                ...
                <form id="frm" action="/prime/login/action" method="post">
                    <?= csrf_field() ?>
                    <div class="input-group mb-3">
                        <input type="" name="id" class="form-control" placeholder="Email">
    ...
    <!-- Bootstrap 4 -->
    <script src="<?=$data['url']['menu']?>/plugins/bootstrap/js/bootstrap.bundle.min.js"></script>
    <!-- AdminLTE App -->
