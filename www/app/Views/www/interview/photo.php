...
<div id="scontent">
    ...
    <div class="face_vdoBox">
        ...
        <div id="btn-start-recording" style="display: none;">
            ...
            <form action="/interview/profile/<?= $data['applyIdx'] ?>/<?= $data['memIdx'] ?>" method="POST" id="photoForm">
                <?= csrf_field() ?>
                <input name="fileIdx" id="fileIdx" type="hidden" value="">
                <input name="selectType" value="P" type="hidden">
                <input name="postCase" id="postCase" value="photoFile" type="hidden">
