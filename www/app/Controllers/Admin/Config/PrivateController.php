...
class PrivateController extends BaseController
{
    ...
    public function private()
    {
        ...
        $aRow = $configModel->getConfigType('P');
        $tmpArrData = [];
        ...
        $aData['data']['private'] = $tmpArrData;
        // view
        $this->header();
        $this->nav();
        echo view('prime/config/private', $aData);
        $this->footer();
    }
    ...
    public function privateAction()
    {
        ...
        if (!$strType || !$strUseYN || !$strContent || $strType != 'P') {
        ...
        return alert_url('저장하였습니다.','/prime/config/private');
    }
