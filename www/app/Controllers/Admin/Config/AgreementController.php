...
class AgreementController extends BaseController
{
    ...
    public function agreement()
    {
        ...
        $aRow = $configModel->getConfigType('A');
        $tmpArrData = [];
        ...
        $aData['data']['agreement'] = $tmpArrData;
        // view
        $this->header();
        $this->nav();
        echo view('prime/config/agreement', $aData);
        $this->footer();
    }
    ...
    public function agreementAction()
    {
        ...
        if (!$strType || !$strUseYN || !$strContent || $strType != 'A') {
        ...
        return alert_url('저장하였습니다.','/prime/config/agreement');
    }
