            ...
            <div class="card-body">
                ...
                <div class="box">
                    ...
                    <div class="row">
                        <table class="table" style="border-bottom: 1px solid #dee2e6;">
                            <thead>
                                <th class="text-center">재응시요청 IDX</th>
                                <th class="text-center">회원 아이디</th>
                                <th class="text-center">회원 이름</th>
                                <th class="text-center">회원 전화번호</th>
                                <th class="text-center">회사명</th>
                                <th class="text-center">재응시공고명 / 재응시 제안명</th>
                                <th class="text-center">재응시요청확인여부</th>
                            ...
                            <tbody>
                                <?php if ($data['list']) : ?>
                                    <?php foreach ($data['list'] as $row) : ?>
                                        ...
                                        <tr>
                                            <td class="text-center"><?= $row['ag_req_idx'] ?? '' ?></td>
                                            <td class="text-center"><?= $row['mem_id'] ?? '없음' ?></td>
                                            <td class="text-center"><?= $row['mem_name'] ?? '' ?></td>
                                            <td class="text-center"><?= $row['mem_tel'] ?? '' ?></td>
                                            <td class="text-center"><?= $row['com_name'] ?? '' ?></td>
                                            <td class="text-center"><?= $row['title'] ?? '' ?></td>
                                            <td class="text-center"><?= $row['ag_req_com'] ?></td>
                                            <td class="text-center">
                                                <?php if ($row['ag_req_com'] == 'Y' && $row['ag_req_stat'] == 'Y') : ?>
                                                    수락
                                            ...
                                            <td class="text-center"><?= $row['ag_req_reg_date'] ?></td>
                                            <td class="text-center"><a href="/prime/again/m/write/<?= $data['againType'] ?? 'recruit' ?>/<?= $row['ag_req_idx'] ?>">보기</a></td>
                                        </tr>
                                    <?php endforeach; ?>
                                <?php else : ?>
